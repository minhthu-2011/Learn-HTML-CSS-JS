function resetInput() {
    ...
    document.getElementById('physicsScores').value = '';
    document.getElementById('chemistryScores').value = '';
}
...
function getStudentForm() {
    ...
    let mathScores = document.getElementById('mathScores').value;
    let physicsScores = document.getElementById('physicsScores').value;
    let chemistryScores = document.getElementById('chemistryScores').value;
    let student = {
        fullname: fullname,
        name: name,
        gender: gender,
...
function renderListStudent() {
    ...
    let tableContent = `<tr style="text-align: center; background-color: #d2afaf; font: caption;">
        <td> ID </td>
        <td> Họ và tên </td>
...
function editStudent(id) {
    ...
    document.getElementById('mathScores').value = students[id].mathScores;
    document.getElementById('physicsScores').value = students[id].physicsScores;
    document.getElementById('chemistryScores').value = students[id].chemistryScores;
...
function updateStudent() {
    ...
    // chỗ này cập nhật thông tin 
    var math = document.getElementById('mathScores').value;
    var physics= document.getElementById('physicsScores').value;
    var chemistry= document.getElementById('chemistryScores').value;
    ...
    students[id] = {
        ...
        physicsScores: document.getElementById('physicsScores').value,
        chemistryScores: document.getElementById('chemistryScores').value,
        mediumScoreTwo: mediumScoreTwo,
        ability: ability
    };
